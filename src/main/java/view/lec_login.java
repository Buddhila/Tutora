...
public class lec_login extends javax.swing.JFrame {
    ...
    private void signinMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_signinMouseClicked
        ...
        if (!user.equals("") && !password.equals("")) {
            try {
                ...
                String sql = "SELECT * FROM lecture WHERE L_id=? and L_PW=?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lec_login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
